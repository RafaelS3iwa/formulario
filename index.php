...
<main>
    ...
    <div class="formulario container">
        ...
        <table>
            <tr>
                <td><label class="form-check-label" for="usoComputador1"><input class="form-check-input" type="radio" name="usoComputador" id="usoComputador1" value="a"></label> Sim</td>
            </tr>
            <tr>
                <td><label class="form-check-label" for="usoComputador2"><input class="form-check-input" type="radio" name="usoComputador" id="usoComputador2" value="b"></label> Não</td>
            </tr>
        </table>
        ...
        <table>
            ...
            <tr>
                <td><label class="form-check-label" for="finalidade4"><input class="form-check-input" type="radio" name="finalidade" id="finalidade4" value="f"></label> Outros
                    <input type="text" name="outros_especifique" placeholder="Especifique">
                </td>
            </tr>
        </table>
    ...
    <div class="formulario container">
        ...
        <table>
            <tr>
                <td><label class="form-check-label" for="licençaSoftware1"><input class="form-check-input" type="radio" name="licençaSoftware1" id="licençaSoftware1" value="u"></label> Sim, sendo eles:
                    <input type="text" name="outros_especifique" placeholder="Especifique">
                </td>
            </tr>
            <tr>
                <td><label class="form-check-label" for="licençaSoftware2"><input class="form-check-input" type="radio" name="licençaSoftware2" id="licençaSoftware2" value="v"></label> Não possuo</td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td><label class="form-check-label" for="compraLicença1"><input class="form-check-input" type="radio" name="compraLicença" id="compraLicença1" value="w"></label> Sim</td>
            </tr>
            <tr>
                <td><label class="form-check-label" for="compraLicença2"><input class="form-check-input" type="radio" name="compraLicença" id="compraLicença2" value="x"></label> Não</td>
            </tr>
        </table>
    </div>
    ...
    <div class="formulario container">
        ...
        <table>
            <tr>
                <td><label class="form-check-label" for="limpezaFisica1"><input class="form-check-input" type="radio" name="limpezaFisica" id="limpezaFisica1" value="a"></label> Sim, regularmente</td>
            </tr>
            <tr>
                <td><label class="form-check-label" for="limpezaFisica2"><input class="form-check-input" type="radio" name="limpezaFisica" id="limpezaFisica2" value="b"></label> Raramente</td>
            </tr>
            <tr>
                <td><label class="form-check-label" for="limpezaFisica3"><input class="form-check-input" type="radio" name="limpezaFisica" id="limpezaFisica3" value="c"></label> Nunca</td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td><label class="form-check-label" for="softwareDownload1"><input class="form-check-input" type="radio" name="softwareDownload1" id="softwareDownload1" value="u"></label> Sim, por favor, liste os softwares desejados:
                    <input type="text" name="outros_especifique" placeholder="Especifique">
                </td>
            </tr>
            <tr>
                <td><label class="form-check-label" for="softwareDownload2"><input class="form-check-input" type="radio" name="softwareDownload2" id="softwareDownload2" value="v"></label> Não</td>
            </tr>
        </table>
    </div>
